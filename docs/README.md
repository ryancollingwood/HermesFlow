...
- `docs/adaptive-repair-retry.md` defines HF-032's policy-gated, attempt-bounded repair approval and lineage-linked retry flow.
- `docs/capability-health-dashboard.md` defines HF-033's authoritative Windmill report, current-state Prometheus projection, and provisioned Grafana dashboard.
- `docs/evaluations/` holds assessments of third-party projects considered for this stack — what they duplicate, what they'd add, and the integration options. Currently: `docs/evaluations/revornix.md`.
